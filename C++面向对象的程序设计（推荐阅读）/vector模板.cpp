...
using namespace std;
typedef int Rank; //秩
#define DEFAULT_CAPACITY 3 //默认的初始容量3
...
{
	for (int i = 0; i < size; i++)visit(_elem[i]);
}
...
void Vector<T>::merge(Rank lo, Rank mi, Rank hi) {
	...
	for (Rank i = 0, i = 0, k = 0; (j < lb) || (k < lc);) {
